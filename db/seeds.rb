...
l=Employer.create(name:"Donkey Anderson", provider:"facebook", uid:"123123")
o=Organization.create(employer_id: l.id ,name: 'CatCo.', description: "Cat People: david bowie too" , contact_email: 'blabla@gmail.com' )
